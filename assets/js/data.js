...
(function (root, factory) {
  ...
  var I18N = {
    es: {
      ...
      'nav.home': 'Inicio', 'nav.posts': 'Blog', 'nav.about': 'Sobre nosotros', 'nav.contact': 'Contacto',
      'hero.eyebrow': 'Blog técnico · en español',
      'hero.w1': 'Imagina', 'hero.w2': 'Explora', 'hero.w3': 'Crea',
      'hero.cta': 'Ir a Blog',
      'home.eyebrow': 'Lo último', 'home.title': 'Posts recientes',
      'home.sub': 'SQL, Python, BI moderno y la carrera en datos — escrito desde la trinchera, sin humo.',
      'home.archive': 'Ir a todos los posts →',
